...
export const metadata = {
    title: "Our Commitment | eventsclick",
    description: "Our 4-step process and dedication to your event's success."
};
        ...
        <div className="pt-20">
            ...
            <section className="py-24 bg-primary text-white text-center">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <a href="/contact" className="inline-block bg-white text-primary px-10 py-4 rounded-full font-bold text-lg hover:bg-white/90 transition-all hover:-translate-y-1 shadow-lg">
                        Work With Us
                    </a>
                </div>
            </section>
